...
Last Change  | Monday November 24, 2014
  ...
  3. Building on GNU/Linux
    1. Building QGIS with Qt 4.x
    2. Prepare apt
    3. Install build dependencies
    4. Setup ccache (Optional)
    5. Prepare your development environment
    6. Check out the QGIS Source Code
    7. Starting the compile
    8. Building Debian packages
  4. Building on Windows
    1. Building with Microsoft Visual Studio
    2. Building using MinGW
    3. Creation of MSYS environment for compilation of QGIS
  5. Building on MacOS X
    1. Install Developer Tools
    2. Install Qt4 from disk image
    3. Install CMake for OSX
    4. Install development frameworks for QGIS dependencies
    5. API documentation
    6. QGIS source
...
Now update your local sources database:
  ...
  | saucy | ``apt-get install bison cmake doxygen flex git graphviz grass-dev libexpat1-dev libfcgi-dev libgdal-dev libgeos-dev libgsl0-dev libopenscenegraph-dev libosgearth-dev libpq-dev libproj-dev libpython2.7-dev libqscintilla2-dev libqt4-dev libqt4-opengl-dev libqtwebkit-dev libqwt5-qt4-dev libspatialindex-dev libspatialite-dev libsqlite3-dev lighttpd locales pkg-config poppler-utils pyqt4-dev-tools python python-dev python-qscintilla2 python-qt4 python-qt4-dev python-sip python-sip-dev spawn-fcgi txt2tags xauth xfonts-100dpi xfonts-75dpi xfonts-base xfonts-scalable xvfb`` |
